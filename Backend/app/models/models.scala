...
case class Drink(id: Option[Long], name: String, volume: Int, description: String, isArchived: Boolean, picture: String, rankingValue: Int, nbRanking: Int, price: Double)
